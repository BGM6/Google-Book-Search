...
// MongoDb Connection
mongoose.connect('mongodb+srv://bgm6:jobelle28@cluster0.npszk.mongodb.net/googlebooksearch?retryWrites=true&w=majority', {
...
db.Book
    ...
    .then(data => {
        console.log(data + " Books have been entered in the database!");
        process.exit(0);
    })
    .catch(err => {
        console.error(err);
